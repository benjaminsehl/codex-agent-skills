...
- Next gate: founder review/acceptance of `.agents/specs/assembly-1-0.md`, then `plan` for release-candidate implementation and proof tasks.
...
Structural migration (2026-06-02): the operational trail moved from `docs/` to
`.agents/` — see `docs/decisions/2026-06-02-agent-docs-audience-split.md`. `docs/`
now holds only human documentation (product, decisions, tech-design).

Stage 0 of `.agents/plans/2026-06-01-assembly-10x-roadmap.md` is in progress. This
...
(`.agents/plans/2026-05-27-assembly-1-0-release-plan.md`) is not abandoned but is no
